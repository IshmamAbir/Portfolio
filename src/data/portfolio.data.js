...
export const userData = {
  first_name_en: "Ishmam",
  middle_name_en: "Abir",
  last_name_en: "Chowdhury",
  first_name_ja: "イシュマム",
  middle_name_ja: "アビル",
  last_name_ja: "チョウドリ",
...
// copied from JobExperiences.vue
export const JobExperiences = [
  {
    id: 1,
    position: "Software Development Engineer",
    company_name: "Kodensya Co. Ltd (株式会社興電舎)",
    company_website: "https://kodensya.co.jp/",
    start_time: "Jan 2023",
    end_time: null,
    company_location_en: "Nobeoka, Miyazaki, Japan",
    company_location_ja: "宮崎県宮崎市",
    short_description_en:
      "I am currently working as a Software Development Engineer at Kodensya Co Ltd (株式会社興電舎). My main responsibilities include: Designing, coding, testing, and debugging company's core web applications. See details page for the complete technical details.",
    short_description_ja:
      "株式会社興電舎でソフトウェア開発エンジニアとして働いています。主な業務は、会社のコアとなるWebアプリケーションの設計、コーディング、テスト、デバッグです。技術的な詳細については、詳細ページをご覧ください。",
    description_en: `
            <P>
  ...
  {
    id: 2,
    position: "Associate Software Engineer-L2",
    company_name: "Brain Station 23 PLC",
    company_website: "https://brainstation-23.com/",
    start_time: "Jan 2022",
    end_time: "Aug 2022",
    company_location_en: "Dhaka, Bangladesh",
    company_location_ja: "ダッカ、 バングラデシュ",
    short_description_en:
      "I got promoted to the Level 2 Associate Software Engineer at Brain Station 23. See details page for the complete technical details.",
    short_description_ja:
      "私は Brain Station 23 でレベル 2 アソシエイト ソフトウェア エンジニアに昇進しました。完全な技術的詳細については、詳細ページをご覧ください。",
    description_en: `
            <p>
    ...
    description_ja: `
            ...
            `,
    img_url: "files/company/Brain-Station-23.jpg",
  },
  {
    id: 3,
    position: "Associate Software Engineer-L1",
    company_name: "Brain Station 23 PLC",
    company_website: "https://brainstation-23.com/",
    start_time: "Sept 2021",
    end_time: "Dec 2021",
    company_location_en: "Dhaka, Bangladesh",
    company_location_ja: "ダッカ、 バングラデシュ",
    short_description_en:
      "I began my professional career as a full-time Associate Software Engineer at Brain Station 23 in 2021. It was a hybrid workplace, where I worked both remotely and onsite. Please refer to the details page for complete technical information.",
    short_description_ja:
      "私は2021年にBrain Station 23でフルタイムのアソシエイトソフトウェアエンジニアとしてキャリアをスタートしました。そこはハイブリッドな職場で、リモートワークとオフサイトワークの両方を行いました。完全な技術的詳細については、詳細ページをご覧ください。",
    description_en: `
            <p>
              Brain Station 23 is a top software development company from Bangladesh, providing custom software, web and mobile apps, and cloud solutions. Serving global clients across various industries, it leverages modern technologies and agile methods to deliver secure, scalable, and innovative digital solutions that drive business transformation.
            </p>
  ...
  {
    id: 4,
    position: "Freelance Web Developer (Contract based)",
    company_name: "BroTech IT Ltd.",
    company_website: "https://www.linkedin.com/company/brotech-it/",
    start_time: "Apr 2020",
    end_time: "Jan 2021",
    company_location_en: "Chittagong, Bangladesh",
    company_location_ja: "チッタゴン、 バングラデシュ",
    short_description_en:
      "My responsibility was to build a website for a client using HTML, CSS, Bootstrap and JavaScript. I also worked on the backend using Node.js. Please refer to the details page for complete technical information.",
    short_description_ja:
      "私の責任は、HTML、CSS、Bootstrap、JavaScriptを使用してクライアントのウェブサイトを構築することでした。また、Node.jsを使用してバックエンドの開発にも取り組みました。完全な技術的詳細については、詳細ページをご覧ください。",
    description_en: `
            <p>
